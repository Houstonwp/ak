...
mod tests {
    ...
    fn test_year_diff() {
        ...
        assert_eq!(day_count.year_diff(start, end), 0.25);
    }
    ...
    fn test_year_diffs() {
        let cases = vec![
            (date(1992, 2, 1), date(1992, 3, 1), 0.0806),
            (date(1992, 2, 1), date(1993, 3, 1), 1.0944),
            (date(1993, 1, 1), date(1993, 2, 21), 0.1417),
            (date(1993, 1, 1), date(1994, 1, 1), 1.0139),
            (date(1993, 1, 15), date(1993, 2, 1), 0.0472),
            (date(1993, 2, 1), date(1993, 3, 1), 0.0778),
            (date(1993, 2, 1), date(1996, 2, 1), 3.0417),
            (date(1993, 2, 1), date(1993, 3, 1), 0.0778),
            (date(1993, 2, 15), date(1993, 4, 1), 0.1250),
            (date(1993, 3, 15), date(1993, 6, 15), 0.2556),
            (date(1993, 3, 31), date(1993, 4, 1), 0.0028),
            (date(1993, 3, 31), date(1993, 4, 30), 0.0833),
            (date(1993, 3, 31), date(1993, 12, 31), 0.7639),
            (date(1993, 7, 15), date(1993, 9, 15), 0.1722),
            (date(1993, 8, 21), date(1994, 4, 11), 0.6472),
            (date(1993, 11, 1), date(1994, 3, 1), 0.3333),
            (date(1993, 12, 15), date(1993, 12, 30), 0.0417),
            (date(1993, 12, 15), date(1993, 12, 31), 0.0444),
            (date(1993, 12, 31), date(1994, 2, 1), 0.0889),
            (date(1996, 1, 15), date(1996, 5, 31), 0.3806),
            (date(1998, 2, 27), date(1998, 3, 27), 0.0778),
            (date(1998, 2, 28), date(1998, 3, 27), 0.0750),
            (date(1999, 1, 1), date(1999, 1, 29), 0.0778),
            (date(1999, 1, 29), date(1999, 1, 30), 0.0028),
            (date(1999, 1, 29), date(1999, 1, 31), 0.0056),
            (date(1999, 1, 29), date(1999, 3, 29), 0.1639),
            (date(1999, 1, 29), date(1999, 3, 30), 0.1667),
            (date(1999, 1, 29), date(1999, 3, 31), 0.1694),
            (date(1999, 1, 30), date(1999, 1, 31), 0.0028),
            (date(1999, 1, 30), date(1999, 2, 27), 0.0778),
            (date(1999, 1, 30), date(1999, 2, 28), 0.0806),
            (date(1999, 1, 30), date(1999, 3, 29), 0.1611),
            (date(1999, 1, 30), date(1999, 3, 30), 0.1639),
            (date(1999, 1, 30), date(1999, 3, 31), 0.1667),
            (date(1999, 1, 31), date(1999, 3, 29), 0.1583),
            (date(1999, 1, 31), date(1999, 3, 30), 0.1611),
            (date(1999, 1, 31), date(1999, 3, 31), 0.1639),
        ];
        for (start, end, expected) in cases {
            let result = Actual360.year_diff(start, end);
            assert!(
    ...
    fn test_day_diffs() {
        ...
        for (start, end, expected) in cases {
            let result = Actual360.day_diff(start, end);
